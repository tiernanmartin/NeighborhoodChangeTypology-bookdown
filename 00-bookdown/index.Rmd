...
```{r findings-wc-map, fig.cap='COO Neighborhood Change Typology: White Center (2018)'}

null_plot <-  ggplot2::ggplot(data = NULL)

p1_labs <- null_plot +
  labs(caption = "Source: author's analysis; Notes: Tracts without a color have either long-term low cost or long-term high cost housing markets.") +
  theme_nct

p1 <- ggdraw() +
  draw_image("images/wc-typo-map.png") +
  draw_plot(null_plot)
...
```{r findings-rv-map, fig.cap='COO Neighborhood Change Typology: Rainier Valley (2018)'}
...
p1 <- ggdraw() +
  draw_image("images/rv-typo-map.png") +
  draw_plot(null_plot)
...
```{r findings-stk-map, fig.cap='COO Neighborhood Change Typology: Seatac/Tukwila (2018)'}
...
p1 <- ggdraw() +
  draw_image("images/stk-typo-map.png") +
  draw_plot(null_plot)
