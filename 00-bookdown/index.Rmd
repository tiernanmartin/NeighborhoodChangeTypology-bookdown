...
Blah blah [see @king_county_2016_2016, pp. 33-35; @townsend_cities_2015, pp.45-50].

Blah blah [@king_county_2016_2016, pp. 33-35; @townsend_cities_2015, pp.45-50].

@king_county_2016_2016 [p. 33] says blah. 
...
p1 <- p1 +labs(y = "Number of Census Tracts",
               ...
               caption = wrapper("Source: author's analysis
                                 \nNotes: the total number of census tracts in King County is 398. The graphic above does not include tracts where 90% or more of the housing units are located in multifamily buildings."))
p1 <- p1 + theme(
